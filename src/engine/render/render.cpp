...
namespace MoleDemo
{
    MoleDemo::Blending::Blending(BlendMode mode) : mode{ mode } {}

    struct MoleDemo::OverrideBlend : public Blending
    {
        MoleDemo::OverrideBlend::OverrideBlend() : Blending{ BlendMode::Override } {}
        rgbaColor MoleDemo::OverrideBlend::Blend(const rgbaColor base, const rgbaColor next) override { return next; }
        rgbaColor MoleDemo::OverrideBlend::Blend(Color& base, Color& next) override { return next.rgba(); };
    };

    struct MoleDemo::AlphaBlend : public MoleDemo::Blending
    {
        MoleDemo::AlphaBlend::AlphaBlend() : Blending{ BlendMode::AlphaBlend } {}

        rgbaColor MoleDemo::AlphaBlend::Blend(const rgbaColor base, const rgbaColor next) override
        {
            Color ref_base{ base };
            Color ref_next{ next };
            return Blend(ref_base, ref_next);
        };
        rgbaColor MoleDemo::AlphaBlend::Blend(Color& base, Color& next) override
        {
    ...
    void MoleDemo::RenderQueue::Render(Renderables& renderables, PixelBuffer& buffer)
    {
...
public:
    ...
    RenderManager(Screen& screen, SDL::SDLManager& sdl) : m_screen{ screen }, sdl{ sdl }, queue{ new RenderQueue() } {}
...
public:
    ...
    StencilBuffer& GetMask() { return mask; }
