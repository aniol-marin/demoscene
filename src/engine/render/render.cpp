...
void
MoleDemo::RenderManager::Lock()
{
    sdl.LockSurface();
}
void
MoleDemo::RenderManager::Unlock()
{
    sdl.UnlockSurface();
}
void
MoleDemo::RenderManager::Render()
{
    sdl.UpdateSurface();
}

void
MoleDemo::RenderManager::Init()
{
...
void
MoleDemo::RenderManager::Finalize()
{
    sdl.Finalize();
}
...
StencilBuffer&
MoleDemo::RenderManager::GetMask()
{
    return mask;
}
