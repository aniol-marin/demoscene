...
GENERATOR_PATH := /usr/local/bin/ninja
CMAKE_LOG_LEVEL := STATUS
CMAKE_PRESET := default
#COMPILER_PATH := /home/bru/userland/llvm-project/build/bin/clang++
#C_COMPILER_PATH := /home/bru/userland/llvm-project/build/bin/clang
